...
const CAPABILITIES = [
  {
    ...
    problem: 'You can\'t stop mid-job to take a call, and voicemail is where leads go to die.',
  ...
  },
  {
    ...
    fix: 'A finished job automatically sends a review request while the customer is still glad they called you.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col items-center">
          ...
          <p className="font-ui text-base sm:text-lg text-slate-300 font-light leading-relaxed text-center w-full mx-auto">
            ...
            get an answer. Four things run in the background, and you keep doing
